...
import CustomerCard from "../pages/viewData/CustomerCard";
...
export default function CardTable({
  ...
  if (!customers) {
    customersList = "there is no customer recored!";
  } else {
    //if (customers.status === "customer") {
    customersList = customers.map((customer, k) => <CardRow customer={customers[0]} key={k} title={customers[0].idNumber}/>);
    //}
  }
