        ...
        <div>
            {userData.user ? (
                <div className="FaceMask">
                    ...
                    <a className="btn btn-primary" href="/staffinfo" role="button"> Staff Info </a><br/><br/>
                    <a className="btn btn-primary" href="/customerdata" role="button"> Customer Data </a><br/><br/>
